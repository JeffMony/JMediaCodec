...
import com.jeffmony.videolibrary.resample.AudioResampler;
import com.jeffmony.videolibrary.resample.DownsampleAudioResampler;
import com.jeffmony.videolibrary.resample.PassThroughAudioResampler;
...
public class PassthroughSoftwareRenderer implements Renderer {
    ...
    public void renderFrame(@Nullable Frame inputFrame, long presentationTimeNs) {
        if (inputFrame == null || inputFrame.mBuffer == null) {
        ...
        do {
            ...
            if (tag >= 0) {
                ...
                ByteBuffer outputBuffer = outputFrame.mBuffer;

                if (isNewInputFrame) {
                    isNewInputFrame = false;
                    inputBuffer = inputFrame.mBuffer.asReadOnlyBuffer();
                    inputBuffer.rewind();
                }
