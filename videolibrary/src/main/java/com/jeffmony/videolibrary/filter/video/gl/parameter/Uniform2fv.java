...
/**
 * Two float element vector shader parameter
 */
public class Uniform2fv extends ShaderParameter {
     ...
     */
    public Uniform2fv(@NonNull String name, int count, @NonNull float[] buffer) {
     ...
     * @param buffer buffer containing new vector values
     */
    public Uniform2fv(@NonNull String name, int count, @NonNull FloatBuffer buffer) {
    ...
    public void apply(int glProgram) {
        GLES20.glUniform2fv(getLocation(glProgram), mCount, mBuffer);
    }
}
